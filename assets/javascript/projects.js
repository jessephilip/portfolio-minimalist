const portfolio = {
	"hangman": {
		...
		"description": 'Everyone knows Hangman, that childhood game of knowledge, skill, and luck. This is my version of that classic. This was one of the first class homeworks, and I did my best to make this assignment my own.

		I imbued it with my sense of humor and tried to achieve a retro style. I went above the parameters of the assignment to "paint" my own graphics with Microsoft Paint. There are also YouTube videos scattered about, a scoring system, and three difficulty settings.

		To this day, this is one of my favorite websites, and if you permit me to say so, I actually find it quite entertaining.'
	},
	...
	"fetch": {
		...
		"description": 'Fetch is a Tinder-style solution to pet adoptions. It was designed to be a frontend website for adoption agencies to host their avaiable pets and aid in the pet adoption process.

		This was a group project in which I was involved in its concept and implementation. I worked on both the user experience and backend code, having to edit HTML, CSS, and Javascript. I am particularly proud of my code that set up the Google "One Click" Sign-In experience.

		I consider this produce to be in its Alpha production and have many plans for further improving it in the future.'
	},
	...
	"mtg": {
		...
		"description": 'MTG the Console is a pet project of mine that I am creating for my local play group. At its heart, it is a tool to keep track of each player\'s life total. In reality, it does so much more.

		Utilizing Firebase.auth() and Google Sign-In, players can join games and see the progress of the game no matter where they are. I plan to provide additional tools such as storyboarding, deck building, and custom point systems.

		MTG the Console is, at heart, my training tool, therefore it has seen many iterations and rewrites as my knowledge of programming has progressed. The original MTG the Console was actually an Android app written in Java and XML using Android Studio. During my education with the UT Coding Bootcamp, it transformed into a simple HTML site with limited Javascript, to using an SQL database, to the current version which utilizes Firebase for authentication and databasing. I plan to put it back on the phone by reworking it for React-Native.'
	},
	...
	"wedding": {
		"name": "Happily Ever Matherne Website",
		"tech": ["HTML", "CSS", "Javascript", "jQuery", "Bootstrap", "Google Fonts", "Font Awesome", "Hover.CSS", "jCarousel"],
		"description": 'I\'m married!!! Go me!!!

		On December 17, 2016, I married the woman of my dreams.
		...
		Please be impressed. I worked hard to do so, and it would make the Mrs. happy.'
